...
ifdef CONFIG_RUST_HLSDEMUX_APPLY
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_HLSPARSER_LIB)
endif
...
ifdef CONFIG_RUST_MPSUB
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_MPSUB_LIB)
endif

ifdef CONFIG_RUST_PJS
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_PJS_LIB)
endif

ifdef CONFIG_RUST_REALTEXT
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_REALTEXT_LIB)
endif

ifdef CONFIG_RUST_AQTITLE
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_AQTITLE_LIB)
endif

ifdef CONFIG_RUST_SAMI
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_SAMI_LIB)
endif

ifdef CONFIG_RUST_ASS
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_ASS_LIB)
endif

ifdef CONFIG_RUST_MCC
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_MCC_LIB)
endif

ifdef CONFIG_RUST_ID3V2
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_ID3V2_LIB)
endif

ifdef CONFIG_RUST_CONCAT
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_CONCAT_LIB)
endif

ifdef CONFIG_RUST_DATA_URI
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_DATA_URI_LIB)
endif

ifdef CONFIG_RUST_FFMETADATA
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_FFMETADATA_LIB)
endif

ifdef CONFIG_RUST_UTIL_PARSE
$(NAME)LINK_EXTRA += $(RUST_FFMPEG_UTIL_PARSE_LIB)
endif
...
ifeq ($(strip $(CONFIG_RUST_HLSWRITER)$(CONFIG_RUST_HLSPARSER)$(CONFIG_RUST_HLSDEMUX_PARSER)$(CONFIG_RUST_HLSDEMUX_APPLY)$(CONFIG_RUST_WEBVTT)$(CONFIG_RUST_SUBRIP)$(CONFIG_RUST_MICRODVD)$(CONFIG_RUST_TTML)$(CONFIG_RUST_MPL2)$(CONFIG_RUST_VPLAYER)$(CONFIG_RUST_JACOSUB)$(CONFIG_RUST_SUBVIEWER)$(CONFIG_RUST_SUBVIEWER1)$(CONFIG_RUST_SCC)$(CONFIG_RUST_STL)$(CONFIG_RUST_LRC)$(CONFIG_RUST_MPSUB)$(CONFIG_RUST_PJS)$(CONFIG_RUST_REALTEXT)$(CONFIG_RUST_AQTITLE)$(CONFIG_RUST_SAMI)$(CONFIG_RUST_ASS)$(CONFIG_RUST_MCC)$(CONFIG_RUST_ID3V2)$(CONFIG_RUST_CONCAT)$(CONFIG_RUST_DATA_URI)$(CONFIG_RUST_FFMETADATA)$(CONFIG_RUST_UTIL_PARSE)),)
else
